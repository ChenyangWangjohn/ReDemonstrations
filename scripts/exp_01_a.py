...
Description: Base model, no ctx_a provided, direct prediction
...
def run_experiment_a(
    ...
    """Run Experiment A: M_base Zero-Shot"""
    print(f"\n{'='*70}")
    print(f"Experiment 01: M_base Zero-Shot")
    print(f"{'='*70}\n")
    ...
    with torch.no_grad():
        for idx, example in enumerate(tqdm(test_data, desc="Experiment 01")):
...
def main():
    parser = argparse.ArgumentParser(description="Experiment 01: M_base Zero-Shot")
